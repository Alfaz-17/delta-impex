        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <article className="group relative overflow-hidden rounded-none border border-slate-100 bg-slate-50/50 p-8 md:p-12 shadow-sm transition-all duration-500 hover:border-accent/30 hover:shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="heading-section text-primary mb-6 group-hover:text-accent transition-colors uppercase tracking-tighter">
                {title1 || "Delta Impex Marine & RO Solutions."}
              </h2>
              <p className="body-text text-slate-600 max-w-lg leading-relaxed">
                {content1 || "Delta Impex is a trusted supplier of marine engine spare parts, industrial machinery components, and RO water treatment systems."}
              </p>
            </div>
          </article>
