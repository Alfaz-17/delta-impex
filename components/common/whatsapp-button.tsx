  ...
  return (
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-3 group">
      ...
      >
        ...
        <div className="relative w-14 h-14 md:w-16 md:h-16 flex items-center justify-center bg-[#25D366] text-white rounded-2xl shadow-[0_15px_30px_-5px_rgba(37,211,102,0.4)] transition-all duration-300">
          {/* Official WhatsApp SVG */}
          <svg viewBox="0 0 24 24" className="w-8 h-8 md:w-9 md:h-9 relative z-10 fill-white">
