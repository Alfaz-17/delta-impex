...
export const InfiniteGrid = ({ className, children, bgClassName }: { className?: string, children?: React.ReactNode, bgClassName?: string }) => {
  ...
  return (
    ...
    >
      ...
      >
        <GridPattern offsetX={gridOffsetX} offsetY={gridOffsetY} className="text-primary/40" id="grid-reveal" />
      </motion.div>

      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute right-[-20%] top-[-20%] w-[40%] h-[40%] rounded-full bg-primary/20 blur-[120px]" />
        <div className="absolute right-[10%] top-[-10%] w-[20%] h-[20%] rounded-full bg-accent/20 blur-[100px]" />
...
const GridPattern = ({ offsetX, offsetY, className, id = "grid-pattern" }: { offsetX: any, offsetY: any, className?: string, id?: string }) => {
  return (
