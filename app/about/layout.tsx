...
export const metadata: Metadata = {
  ...
  description: "Discover the legacy of Delta Impex. Based in India, we are experts in sourcing marine engines, spare parts, and industrial equipment for shipowners and industrial plants worldwide",
